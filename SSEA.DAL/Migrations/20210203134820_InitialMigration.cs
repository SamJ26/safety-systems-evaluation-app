        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CCF_min = table.Column<short>(type: "smallint", nullable: false),
                    CCF_max = table.Column<short>(type: "smallint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HFT", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Id_created = table.Column<int>(type: "int", nullable: false),
                    DT_created = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Id_updated = table.Column<int>(type: "int", nullable: true),
                    DT_updated = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FailureMode = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    Value = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CCF_relevant = table.Column<bool>(type: "bit", nullable: false),
                    MTTFd_min_Id = table.Column<int>(type: "int", nullable: true),
                    MTTFd_max_Id = table.Column<int>(type: "int", nullable: true),
                    DC_min_Id = table.Column<int>(type: "int", nullable: true),
                    DC_max_Id = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Category", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Category_DC_DC_max_Id",
                        column: x => x.DC_max_Id,
                        principalTable: "DC",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Category_DC_DC_min_Id",
                        column: x => x.DC_min_Id,
                        principalTable: "DC",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Category_MTTFd_MTTFd_max_Id",
                        column: x => x.MTTFd_max_Id,
                        principalTable: "MTTFd",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Category_MTTFd_MTTFd_min_Id",
                        column: x => x.MTTFd_min_Id,
                        principalTable: "MTTFd",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Channels = table.Column<short>(type: "smallint", nullable: false),
                    SFF_min = table.Column<double>(type: "float", nullable: false),
                    SFF_max = table.Column<double>(type: "float", nullable: false),
                    HFT_Id = table.Column<int>(type: "int", nullable: true),
                    PFHd_max_Id = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Architecture", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Architecture_HFT_HFT_Id",
                        column: x => x.HFT_Id,
                        principalTable: "HFT",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Architecture_PFHd_PFHd_max_Id",
                        column: x => x.PFHd_max_Id,
                        principalTable: "PFHd",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Description = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    TypeOfFunction_Id = table.Column<int>(type: "int", nullable: true),
                    EvaluationMethod_Id = table.Column<int>(type: "int", nullable: true),
                    PLr_Id = table.Column<int>(type: "int", nullable: true),
                    PL_result_Id = table.Column<int>(type: "int", nullable: true),
                    ...
                    SIL_result_Id = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SafetyFunction_PFHd_SIL_result_Id",
                        column: x => x.SIL_result_Id,
                        principalTable: "PFHd",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SafetyFunction_PL_PL_result_Id",
                        column: x => x.PL_result_Id,
                        principalTable: "PL",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TypeOfSubsystem_Id = table.Column<int>(type: "int", nullable: true),
                    CCF_valid = table.Column<bool>(type: "bit", nullable: false),
                    Category_Id = table.Column<int>(type: "int", nullable: true),
                    MTTFd_result_Id = table.Column<int>(type: "int", nullable: true),
                    DC_result_Id = table.Column<int>(type: "int", nullable: true),
                    PL_result_Id = table.Column<int>(type: "int", nullable: true),
                    T1 = table.Column<double>(type: "float", nullable: true),
                    T2 = table.Column<double>(type: "float", nullable: true),
                    SFF_result = table.Column<double>(type: "float", nullable: true),
                    Architecture_Id = table.Column<int>(type: "int", nullable: true),
                    HFT_Id = table.Column<int>(type: "int", nullable: true),
                    PFHd_result_Id = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Subsystem_DC_DC_result_Id",
                        column: x => x.DC_result_Id,
                        principalTable: "DC",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Subsystem_HFT_HFT_Id",
                        column: x => x.HFT_Id,
                        principalTable: "HFT",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Subsystem_MTTFd_MTTFd_result_Id",
                        column: x => x.MTTFd_result_Id,
                        principalTable: "MTTFd",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Subsystem_PFHd_PFHd_result_Id",
                        column: x => x.PFHd_result_Id,
                        principalTable: "PFHd",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Subsystem_PL_PL_result_Id",
                        column: x => x.PL_result_Id,
                        principalTable: "PL",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccessPoints_MaxCount = table.Column<int>(type: "int", nullable: true),
                    EthernetAdresses_MaxCount = table.Column<long>(type: "bigint", nullable: true),
                    PL_max_Id = table.Column<int>(type: "int", nullable: true),
                    Category_max_Id = table.Column<int>(type: "int", nullable: true),
                    SIL_max_Id = table.Column<int>(type: "int", nullable: true),
                    Architecture_max_Id = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TypeOfLogic", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TypeOfLogic_Architecture_Architecture_max_Id",
                        column: x => x.Architecture_max_Id,
                        principalTable: "Architecture",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TypeOfLogic_Category_Category_max_Id",
                        column: x => x.Category_max_Id,
                        principalTable: "Category",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TypeOfLogic_PFHd_SIL_max_Id",
                        column: x => x.SIL_max_Id,
                        principalTable: "PFHd",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TypeOfLogic_PL_PL_max_Id",
                        column: x => x.PL_max_Id,
                        principalTable: "PL",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NextState_Id = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    n_op = table.Column<double>(type: "float", nullable: true),
                    h_op = table.Column<double>(type: "float", nullable: true),
                    d_op = table.Column<double>(type: "float", nullable: true),
                    t_cycles = table.Column<double>(type: "float", nullable: true),
                    MTTFd_counted = table.Column<double>(type: "float", nullable: true),
                    MTTFd_result_Id = table.Column<int>(type: "int", nullable: true),
                    C = table.Column<double>(type: "float", nullable: true),
                    lambda_c = table.Column<double>(type: "float", nullable: true),
                    Id_created = table.Column<int>(type: "int", nullable: false),
                    DT_created = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Id_updated = table.Column<int>(type: "int", nullable: true),
                    DT_updated = table.Column<DateTime>(type: "datetime2", nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Element_MTTFd_MTTFd_result_Id",
                        column: x => x.MTTFd_result_Id,
                        principalTable: "MTTFd",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Producer_Id = table.Column<int>(type: "int", nullable: true),
                    EvaluationMethod_Id = table.Column<int>(type: "int", nullable: true),
                    MachineType_Id = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Architecture_HFT_Id",
                table: "Architecture",
                column: "HFT_Id");

            migrationBuilder.CreateIndex(
                name: "IX_Architecture_PFHd_max_Id",
                table: "Architecture",
                column: "PFHd_max_Id");

            migrationBuilder.CreateIndex(
                name: "IX_Category_DC_max_Id",
                table: "Category",
                column: "DC_max_Id");

            migrationBuilder.CreateIndex(
                name: "IX_Category_DC_min_Id",
                table: "Category",
                column: "DC_min_Id");

            migrationBuilder.CreateIndex(
                name: "IX_Category_MTTFd_max_Id",
                table: "Category",
                column: "MTTFd_max_Id");

            migrationBuilder.CreateIndex(
                name: "IX_Category_MTTFd_min_Id",
                table: "Category",
                column: "MTTFd_min_Id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Element_MTTFd_result_Id",
                table: "Element",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SafetyFunction_PL_result_Id",
                table: "SafetyFunction",
                column: "PL_result_Id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SafetyFunction_SIL_result_Id",
                table: "SafetyFunction",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Subsystem_DC_result_Id",
                table: "Subsystem",
                column: "DC_result_Id");

            migrationBuilder.CreateIndex(
                name: "IX_Subsystem_HFT_Id",
                table: "Subsystem",
                column: "HFT_Id");

            migrationBuilder.CreateIndex(
                name: "IX_Subsystem_MTTFd_result_Id",
                table: "Subsystem",
                column: "MTTFd_result_Id");

            migrationBuilder.CreateIndex(
                name: "IX_Subsystem_PFHd_result_Id",
                table: "Subsystem",
                column: "PFHd_result_Id");

            migrationBuilder.CreateIndex(
                name: "IX_Subsystem_PL_result_Id",
                table: "Subsystem",
                column: "PL_result_Id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TypeOfLogic_Architecture_max_Id",
                table: "TypeOfLogic",
                column: "Architecture_max_Id");

            migrationBuilder.CreateIndex(
                name: "IX_TypeOfLogic_Category_max_Id",
                table: "TypeOfLogic",
                column: "Category_max_Id");

            migrationBuilder.CreateIndex(
                name: "IX_TypeOfLogic_PL_max_Id",
                table: "TypeOfLogic",
                column: "PL_max_Id");

            migrationBuilder.CreateIndex(
                name: "IX_TypeOfLogic_SIL_max_Id",
                table: "TypeOfLogic",
                column: "SIL_max_Id");
        }
