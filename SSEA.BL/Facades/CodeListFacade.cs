...
namespace SSEA.BL.Facades
{
    public class CodeListFacade
    {
        ...
        private async Task<ICollection<CCFModel>> GetAllCCFModels()
        {
            ...
            var data = await repository.GetAll().AsTracking(QueryTrackingBehavior.NoTracking).ToListAsync();
        ...
        private async Task<ICollection<TypeOfLogicModel>> GetAllTypeOfLogicModels()
        {
            ...
            var data = await repository.GetAll().AsTracking(QueryTrackingBehavior.NoTracking)
        ...
        private async Task<ICollection<ArchitectureModel>> GetAllArchitectureModels()
        {
            ...
            var data = await repository.GetAll().AsTracking(QueryTrackingBehavior.NoTracking).Include(a => a.MaxPFHd)
                                                .ToListAsync();
